...
create or replace transient table DEEL.analytics.fct_globepay__transactions
    
    
    
    as (-- models/marts/fct_globepay__transactions.sql
--
...
chargeback as (
    select * from DEEL.staging.stg_globepay__chargeback
),
